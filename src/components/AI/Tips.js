...
const Tips = () => {
  ...
  }, [firstAlarmAnnounced, threeSixtyWalkthroughBegan, fullSectionText, partialSectionText, dispatch]);
  ...
  }, [threeSixtyWalkthroughCompleted, threeSixtyAssessmentCompleted, fullSectionText, partialSectionText, dispatch]);

  useEffect(() => {
    if (threeSixtyAssessmentCompleted && (!assignmentsCompleted || !faceToFaceRequested)) {
      const commands = allText(fullSectionText, partialSectionText);
  ...
  }, [threeSixtyAssessmentCompleted, assignmentsCompleted, faceToFaceRequested, fullSectionText, partialSectionText, dispatch]);
