...
const SpeechToText = props => {
  ...
  const convertFromBuffer = (bytes, timer) => {
    ...
    console.log(`${elapsed}: ${convertDelta} seconds to convert mic stream to audio file`);
    ...
    .then(({ transcription: { fullText } }) => {
      ...
      console.log(`${elapsed}: ${transcribeDelta} seconds to transcribe audio file to text`);
